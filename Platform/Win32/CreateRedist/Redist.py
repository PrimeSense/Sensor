...
# copy EPL
shutil.copy(os.path.join(ROOT_DIR, "..", "..", "..", "LICENSE"), REDIST_DIR)
shutil.copy(os.path.join(ROOT_DIR, "..", "..", "..", "LICENSE"), OUTPUT_DIR)
shutil.copy(os.path.join(ROOT_DIR, "..", "..", "..", "NOTICE"), REDIST_DIR)
shutil.copy(os.path.join(ROOT_DIR, "..", "..", "..", "NOTICE"), OUTPUT_DIR)
